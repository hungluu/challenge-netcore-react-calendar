        ...
        return <div className="animated fadeIn">
            ...
            <Card>
                <CardBody>
                    ...
                    <Row>
                        <Col>
                            <Button type="reset" color="primary" onClick={() => this.addNewShiftSetting()} disabled={!!find(this.state.shiftSettings, st => !st.id && !st.isDeleted)}><i className="fa fa-plus"></i> Add shift</Button>
                        </Col>
                        <Col>
